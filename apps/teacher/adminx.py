...
from .models import Teacher, FamilyTeacher, TeamTeacher, MarriageTeacher, SandboxTeacher, TrainTeacher, SocialTeacher
...
@xadmin.sites.register(TrainTeacher)
class TrainTeacherAdmin(object):
    class TeacherResources(resources.ModelResource):
        class Meta:
            model = Teacher
            fields = ('teacher_name', 'teacher_class', 'teacher_info', 'teacher_date', 'teacher_fare', 'teacher_paid')
...
@xadmin.sites.register(SocialTeacher)
class SocialTeacherAdmin(object):
    class TeacherResources(resources.ModelResource):
        class Meta:
            model = Teacher
            fields = ('teacher_name', 'teacher_class', 'teacher_info', 'teacher_date', 'teacher_fare', 'teacher_paid')
